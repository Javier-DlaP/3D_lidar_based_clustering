...
def addBoundingBox(object3d):
    ...
    """
    """
    p0 = [object3d.tx, object3d.ty, object3d.tz]
    p1 = [object3d.tx, object3d.ty, object3d.tz+object3d.h]
    p2 = [object3d.tx-object3d.w*math.sin(object3d.rz), object3d.ty+object3d.w*math.cos(object3d.rz), object3d.tz]
    p3 = [object3d.tx-object3d.w*math.sin(object3d.rz), object3d.ty+object3d.w*math.cos(object3d.rz), object3d.tz+object3d.h]
    p4 = [object3d.tx+object3d.l*math.cos(object3d.rz), object3d.ty+object3d.l*math.sin(object3d.rz), object3d.tz]
    p5 = [object3d.tx+object3d.l*math.cos(object3d.rz), object3d.ty+object3d.l*math.sin(object3d.rz), object3d.tz+object3d.h]
    p6 = [object3d.tx+object3d.l*math.cos(object3d.rz)-object3d.w*math.sin(object3d.rz), object3d.ty+object3d.w*math.cos(object3d.rz)+object3d.l*math.sin(object3d.rz), object3d.tz]
    p7 = [object3d.tx+object3d.l*math.cos(object3d.rz)-object3d.w*math.sin(object3d.rz), object3d.ty+object3d.w*math.cos(object3d.rz)+object3d.l*math.sin(object3d.rz), object3d.tz+object3d.h]
    """
    ...
    for elem in [p0, p1, p3, p2, p0, p4, p5, p7, p6, p4, p0, p6, p2, p4, p1, p5, p0, p3, p1, p2, p7, p3, p6, p5, p4, p7, p1, p3, p5]:
        x.append(elem[0])
        y.append(elem[1])
        z.append(elem[2])
